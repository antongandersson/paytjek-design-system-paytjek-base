    ...
    <Sidebar className="border-r-0">
      ...
      <SidebarHeader className="bg-white border-b border-border p-5">
        <Link to="/app" className="flex items-center gap-3 hover:opacity-90 transition-opacity">
          <img src={hkLogo} alt="HK Handel" className="h-10 w-auto mix-blend-multiply" />
          <span className="font-bold text-lg text-foreground">HK Handel</span>
        </Link>
      </SidebarHeader>
      ...
      <SidebarFooter className="p-4 bg-card border-t border-border">
        ...
        <div className="flex items-center gap-3 p-3 rounded-xl bg-primary/5 mb-3">
          <Avatar className="h-10 w-10 border-2 border-primary/20">
            <AvatarImage src="" alt="Emil" />
            <AvatarFallback className="bg-primary text-primary-foreground font-bold">
              EH
            </AvatarFallback>
          </Avatar>
          <div className="flex-1 min-w-0">
            <p className="text-sm font-bold truncate">Emil Hansen</p>
            <p className="text-xs text-muted-foreground truncate">emil@demo.dk</p>
          </div>
        </div>
